...
;(async () => {
  const banner = [
'     _    __      _     _________      __        __          _____      __            ',
'| |  / /___  (_)___/ /_  __(_)____/ /_____  / /______   / ___/___  / /___  ______ ',
'| | / / __ \\/ / __  / / / / / ___/ //_/ _ \\/ __/ ___/   \\__ \\/ _ \\/ __/ / / / __ \\',
'| |/ / /_/ / / /_/ / / / / / /__/ ,< /  __/ /_(__  )   ___/ /  __/ /_/ /_/ / /_/ /',
'|___/\\____/_/\\__,_/ /_/ /_/\\___/_/|_|\\___/\\__/____/   /____/\\___/\\__/\\__,_/ .___/ ',
'                                                                         /_/      '
  ];
  ...
  const cfg = {
    ...
    managementRoles: management ? management.split(',').map(s => s.trim()).filter(Boolean) : [],
    ticketLogChannelId: ticketLogChannelId || null,
    vouchChannelId: vouchChannelId || null,
    autocloseMinutes: parseInt(autoclose) || 1440,
    ticketCounter: 0
  };
  ...
  const commands = [
    {
      ...
      options: [
        { name: 'create', type: 1, description: 'Create a ticket' },
        { name: 'stats', type: 1, description: 'Show ticket claim stats' }
      ]
    },
    {
      name: 'vouch',
      ...
      options: [
        { name: 'user', description: 'User to vouch for', type: 6, required: true },
        { name: 'reason', description: 'Reason', type: 3, required: false },
        { name: 'global', description: 'Broadcast globally', type: 5, required: false }
      ]
    }
  ];
